...
export const Conducteur = (props: IConducteurProps) => {
  ...
  return (
    <div>
      <h2 id="conducteur-heading">
        <Translate contentKey="gestionTransportApp.conducteur.home.title">Conducteurs</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gestionTransportApp.conducteur.home.createLabel">Create new Conducteur</Translate>
        </Link>
      </h2>
                ...
                <tr key={`entity-${i}`} >
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${conducteur.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
...
const mapStateToProps = ({ conducteur }: IRootState) => ({
  conducteurList: conducteur.entities,
  loading: conducteur.loading,
  totalItems: conducteur.totalItems,
});
